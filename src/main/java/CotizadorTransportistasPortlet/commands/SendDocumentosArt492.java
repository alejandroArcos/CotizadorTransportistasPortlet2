...
import com.tokio.cotizadorModular.Bean.InformacionLegal;
...
import CotizadorTransportistasPortlet.util.SendMailLegal492;
...
public class SendDocumentosArt492 extends BaseMVCResourceCommand{
	...
	private void enviaMail(ResourceRequest resourceRequest) throws CotizadorModularException {
		...
		InformacionLegal infLegal = _ServicePaso4.informacionLegal(cotizacion, version, idPerfil, CotizadorTransportistasPortletKeys.CotizadorTransportistas, usuario);
