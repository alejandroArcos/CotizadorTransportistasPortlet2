...
<section id="cotizadores-p3" class="upper-case-all">
	...
	<div class="container-fluid" id="divPaso3">
		...
		<div class="row ${ perfilSuscriptor == 1 || perfilJapones == 1 ? '' : 'd-none'}" style="padding: 0 70px;">
			<div class="col-md-3">
				<div class="form-check mt-4">
			...
			<div class="col-md-3">
				<div class="md-form siniestraValida">
					<input type="text" id="noAjustes" class="form-control moneda" value="${caratulaResponse.p_sinisetralidadNumero}">
		...
		<div class="col-md-9" ${ (Leg492 == 'factura') ? 'hidden' : '' }>
			<div class="row mb-2 mt-5">
				...
				<div class="col-md-12 text-right">
					...
					<button class="btn btn-pink ${ (perfilJapones == 1 && infCotizacion.canalNegocio == 2525) || (perfilSuscriptor != 1) ? 'd-none' : '' } " id="paso3_next" onclick="clickBtnNext();">Enviar Cotización</button>
					...
					<button class="btn btn-pink" id="paso3_next_form" disabled>Solicitar Emisión</button>
				</div>
			</div>
		</div>
	</div>
